...
<body bgcolor = "#F9F7F7">
  ...
  <div class = "maindiv">
    ...
    ?>
      <!-- 如果是自己派發的，則案件用背景色標示 -->
      <tr <?php if($row["transclient"] == $name){echo "bgcolor='#F9F7F7'";}?>>
        ...
        <?php
          // 如果是自己派發的，派件客戶就粗體標示
          if($row["transclient"] == $name)
          {
            echo "<td><b><font size = 4>". $row["transclient"] ."</font></b></td>";
          }
          else
          {
            echo "<td><font size = 4>". $row["transclient"] ."</font></td>";
          }        
        ?>        
